...
SOURCE_BUCKET = "polystudents3-tp4-marie"            # bucket q2
...
def enable_cloudtrail_for_bucket():
    ...
    # 1) Ajouter la bucket policy nécessaire pour CloudTrail
    ensure_cloudtrail_bucket_policy(TRAIL_BUCKET, ACCOUNT_ID)

    # 2) Vérifier si le trail existe 
